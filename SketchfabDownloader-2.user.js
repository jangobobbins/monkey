...
(function() {
    ...
    var parseobj = function(obj)
    {
        ...
        obj._primitives.forEach(function(p) {
            console.log("parseobj  obj._primitives.forEach");
            if(p && p.indices) {
                list.push({
                    'mode' : p.mode,
    ...
    window.drawhookcanvas = function(e, imagemodel)
    {
        ...
        {
            console.log("drawhookcanvas return e early");
            return e;
        }
        if(imagemodel)
        {
            console.log("drawhookcanvas imagemodel exists");

            var alpha = e.options ? e.options.format : "B";
            ...
            imagemodel.attributes.images.forEach(function(img)
                                                 {
                console.log("drawhookcanvas imagemodel.attributes.images.forEach");
            ...
            {
                console.log("drawhookcanvas saveimage_to_list");
                //console.log(e);
    ...
    {
        console.log("drawhookimg");
        if (!t || !t[5] || !t[5].currentSrc) {
            console.error("Invalid input: t[5] or currentSrc is undefined.", t);
            return;
        }
        ...
        if(!saveimagecache2[url])
        {
            console.log("drawhookimg rejected:"+url);
            return;
        }
        else
        {
            console.log("drawhookimg saved texture:"+url);
        }
        ...
        {
            console.log("drawhookimg halfHeight loop");
